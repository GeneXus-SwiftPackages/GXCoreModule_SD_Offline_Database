...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXDataLayerLocal.git", exact: "1.1.0-rc.1")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Offline_Database",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Offline_Database-1.1.0-rc.1.xcframework.zip",
			checksum: "2b774117875a809b332da6af22659c49ec6e250048483769c0bb8d42c8b9a6b1"
		)
	]
)