...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXDataLayerLocal.git", exact: "1.2.0-rc.15")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Offline_Database",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Offline_Database-1.2.0-rc.15.xcframework.zip",
			checksum: "b37c2f6f090077f1d044c35336d68dc2629e1b8a98a260b83b50c34d1570b071"
		)
	]
)