...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXDataLayerLocal.git", exact: "4.2.0-beta.3")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Offline_Database",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Offline_Database-4.2.0-beta.3.xcframework.zip",
			checksum: "e8082f86d3b181d1403cc8a12db00f789b94353bd238885a0c3e99a07194aa11"
		)
	]
)