...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Offline_Database",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Offline_Database-1.0.0-beta+20230217024255.xcframework.zip",
			checksum: "9912faab24cada27314105d6c280b3de0bd493cddb258a924f0e166f6e57842a"
		)
	]
)