...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXDataLayerLocal.git", exact: "2.0.0-rc.36")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Offline_Database",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Offline_Database-2.0.0-rc.36.xcframework.zip",
			checksum: "bb1b329f2ff5ed709863e19ebd93489a7b690cfe5e157c4928850b6561c0b439"
		)
	]
)