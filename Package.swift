...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXDataLayerLocal.git", exact: "1.1.0-beta.9")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Offline_Database",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Offline_Database-1.1.0-beta.9.xcframework.zip",
			checksum: "3060fdbd3f5e53f9be86ff5b7baa60ea17821fa36824ca5e90205b94d8a1a115"
		)
	]
)