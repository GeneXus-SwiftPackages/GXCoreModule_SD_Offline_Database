...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Offline_Database",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Offline_Database-1.0.0-beta+20230503131704.xcframework.zip",
			checksum: "9c676c24c25f74aa6136d6f3516c0d3c43ed318def71ead2b4633a2418e7bae1"
		)
	]
)