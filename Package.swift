...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXDataLayerLocal.git", exact: "2.1.0-beta.26")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Offline_Database",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Offline_Database-2.1.0-beta.26.xcframework.zip",
			checksum: "83237a3c85830dea0b27955145dbef7b7e2acbf9bb1c86f7975c60bccd818a21"
		)
	]
)