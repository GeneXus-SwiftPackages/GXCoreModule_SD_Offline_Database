...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXDataLayerLocal.git", exact: "1.5.0-rc.28")
	],
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Offline_Database",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Offline_Database-1.5.0-rc.28.xcframework.zip",
			checksum: "91fae67362c03ebdff72e9084376b262dd3712a086d0e51fef0618357ddd0b50"
		)
	]
)